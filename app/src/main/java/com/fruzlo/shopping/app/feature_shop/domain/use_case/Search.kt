...
class Search @Inject constructor(val repository: Repository) {

    suspend operator fun invoke(query:String): ProductListDto {
        return repository.getSelectedProductList(query)
    }
